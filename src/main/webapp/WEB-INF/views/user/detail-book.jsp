...
<section id="selling-product" class="single-product mt-0 mt-md-5">
  <div class="container-fluid">
        ...
        <div class="product-info">
          ...
          <div class="cart-wrap py-5">
            ...
            <div class="qty-button d-flex flex-wrap pt-3">
              <button type="submit" class="btn muangay btn-primary py-3 px-4 text-uppercase me-3 mt-3">Mua ngay</button>
    ...
    <!-- Tab mô tả, thông tin chi tiết, đánh giá -->
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
                ...
                <div class="row">
                  <div class="d-flex flex-column flex-md-row align-items-start gap-5">
                    <div class="nav flex-row flex-wrap flex-md-column nav-pills me-3 col-lg-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                      <button class="nav-link text-start active" id="v-pills-description-tab" data-bs-toggle="pill" data-bs-target="#v-pills-description" type="button" role="tab" aria-controls="v-pills-description" aria-selected="true">Chi Tiết</button>
                      <button class="nav-link text-start" id="v-pills-additional-tab" data-bs-toggle="pill" data-bs-target="#v-pills-additional" type="button" role="tab" aria-controls="v-pills-additional" aria-selected="false" tabindex="-1">Thông Tin Thêm</button>
                      <button class="nav-link text-start" id="v-pills-reviews-tab" data-bs-toggle="pill" data-bs-target="#v-pills-reviews" type="button" role="tab" aria-controls="v-pills-reviews" aria-selected="false" tabindex="-1">Đánh Giá</button>
                    </div>
                      ...
                      <div class="tab-pane fade" id="v-pills-additional" role="tabpanel" aria-labelledby="v-pills-additional-tab" tabindex="0">
                        ...
                        <div class="meta-product py-2">
                          ...
                          <div class="meta-item d-flex align-items-baseline">
                            ...
                            <ul class="select-list list-unstyled d-flex">
                              <li class="select-item">${product.quantityPage} tờ</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                      <!-- Tab đánh giá khách hàng (chưa có nội dung) -->
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="section-header d-flex justify-content-between my-5">
            ...
            <div class="d-flex align-items-center">
              <div class="swiper-buttons">
                <button class="swiper-prev products-carousel-prev btn btn-primary swiper-button-disabled" tabindex="-1" aria-label="Previous slide" aria-disabled="true" disabled>❮</button>
                <button class="swiper-next products-carousel-next btn btn-primary" tabindex="0" aria-label="Next slide" aria-disabled="false">❯</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-12">
          <div class="products-carousel swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
            <div class="swiper-wrapper" id="swiper-wrapper-27c5ac6294c32634" aria-live="polite" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
              <!-- Sản phẩm liên quan sẽ được render ở đây -->
            </div>
