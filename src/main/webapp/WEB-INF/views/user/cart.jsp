...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid">
        <div class="d-flex justify-content-between">
          ...
          <nav class="breadcrumb fs-6">
            <a class="breadcrumb-item nav-link" href="<c:url value='/home'/>"
              >Trang chủ</a
            >
    ...
    <section class="py-5">
      <div class="container-fluid">
        <div class="row g-5" id="empty-cart">
          <div class="col-md-8">
            <div class="table-responsive cart position-relative">
              <table class="table">
                <div class="loading-overlay">
                  <div class="spinner-border m-5 text-warning">
                    <thead>
                      <tr>
                        <th
                          scope="col"
                    ...
                    <c:forEach var="item" items="${cartItems}">
                      <tr>
                        ...
                        <td class="py-4" scope="row">
                          <div
                            class="cart-info d-flex flex-wrap align-items-center mb-4"
                          >
                            <div class="col-lg-3">
                        ...
                        <td class="py-4">
                          <div class="d-flex align-items-center">
                            <div
                              class="input-group product-qty w-50 d-flex align-items-center"
                              style="height: 120px"
                            >
                    ...
                    <tr class="subtotal pt-2 pb-2 border-top border-bottom">
                      ...
                      <td data-title="Subtotal">
                        <span class="price-amount amount text-dark ps-5">
                          <bdi style="text-transform: lowercase">
                            <span
