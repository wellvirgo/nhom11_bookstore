      ...
      <div class="container-fluid">
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-5 d-none d-lg-block">
            <div class="search-bar row bg-light p-2 my-2 rounded-4 justify-content-between">
              <div class=" col-md-11">
                <form id="search-form" class="text-center" action="index.html" method="post">
                <input type="text" class="form-control border-0 bg-transparent" id="menusearch" placeholder="Search for more than 20,000 products" />
                </form>
              </div>
              <div class="col-1">
            ...
            <ul class="d-flex justify-content-end list-unstyled m-0">
              <li>
                <a href="#" class="rounded-circle bg-light p-2 mx-1 position-relative">
                  ...
                  <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill" style="background-color: #ffc43f;">
                    4
              ...
              <li>
                <a href="user.html" class="rounded-circle bg-light p-2 mx-1">
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                    <li class="nav-item active">
                      <a href="list-book.html" class="nav-link">Sản phẩm</a>
                    </li>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          ...
                          <a href="detail-product.html?id=1" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1 px-4 py-3 mt-3">Xem thử</a>
                        </div>
                    ...
                    >
                      <div class="product-item " >
                        ...
                        <div class="d-flex align-items-center ">
                          ...
                          <a href="list-book.html" class="nav-link">Add to Cart <iconify-icon icon="uil:shopping-cart"></a>
                        </div>
                      </div>
                    </div>
      ...
      <div class="container-fluid" data-aos="fade-up">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap  my-5">
