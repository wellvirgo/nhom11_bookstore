...
<html lang="en">
  <head>
    ...
    <style>
        ...
        /* Add new styles for horizontal menu */
        .horizontal-menu {
          padding: 20px 0;
    ...
    >
      <div class="container-fluid">
        <div class="d-flex justify-content-between">
          <h1 class="page-title pb-2">Người dùng</h1>
          <nav class="breadcrumb fs-6">
            <a class="breadcrumb-item nav-link" href="index.html">Home</a>
            <a class="breadcrumb-item nav-link" href="user.html">Người dùng</a>
            <span class="breadcrumb-item active" href="#">Hồ sơ cá nhân</span>
          </nav>
        </div>
      </div>
    </section>
        ...
        <div class="col-md-3">
          <div class="profile-menu card border-0 p-4">
            <div class="nav flex-column">
              ...
              <hr class="my-3">
              <a href="#" class="nav-item d-flex align-items-center danger" id="logoutBtn">
