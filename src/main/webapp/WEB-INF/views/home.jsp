...
<head>
  ...
  <!-- ...các link css và meta khác giữ nguyên như bạn đã có... -->
    ...
    <div class="offcanvas-body">
      <div class="order-md-last">
        ...
        <button class="w-100 btn btn-primary btn-lg" type="submit">
          <a href="cart.html" class="nav-link">Xem giỏ hàng</a>
        </button>
      </div>
    </div>
  </div>
  ...
  <header>
    <div class="container-fluid">
      <div class="row py-3 border-bottom">
        <div class="col-sm-4 col-lg-3 text-center text-sm-start d-flex justify-content-sm-start justify-content-center">
          <div class="main-logo d-flex align-items-center">
            <a href="index.html">
              <img src="/images/book-shop.png" alt="logo" height="54" >
            </a>   
          </div>
          <div class="d-flex align-items-center ms-1">
            <span><span style="color: #222;font-size: 25px;">Book</span><span style="color: #FDC650;font-size: 25px;">Store</span></span>
          </div>
        </div>
            ...
            <div class="bootstrap-tabs product-tabs">
              <div class="filter-shop d-flex justify-content-between">
                <div class="showing-product">
                  <p>Hiển thị <c:out value="${fn:length(listSP)}"/> sản phẩm</p>
                </div>
                <div class="sort-by">
                      ...
                      <c:forEach var="p" items="${listSP}">
                        <div class="col mb-4">
                          <div class="product-item card h-100">
                            <a href="${pageContext.request.contextPath}/user/detail/${p.id}" class="btn-wishlist position-absolute end-0 m-2"><svg width="24" height="24"><use xlink:href="#heart"></use></svg></a>
                            <figure class="text-center mt-3">
                              <a href="${pageContext.request.contextPath}/user/detail/${p.id}" title="${p.name}">
                                <img
                                  src="${not empty productImages[p.id] ? productImages[p.id] : '/images/bookNNA.png'}"
                                  class="tab-image card-img-top"
                                  style="max-height:180px; object-fit:contain;"
                                />
                              </a>
                            </figure>
                            <div class="card-body d-flex flex-column">
                              <h3 class="card-title fs-5 mb-2">${p.name}</h3>
                              <span class="qty text-muted mb-1">Số lượng: ${p.quantityAvailable}</span>
                              <span class="price fw-bold mb-2"><fmt:formatNumber value="${p.price}" type="currency" currencySymbol="₫"/></span>
                              <div class="mt-auto d-flex align-items-center justify-content-between">
                                <form action="${pageContext.request.contextPath}/user/add-to-cart" method="post" class="d-flex align-items-center">
                                  <input type="hidden" name="productId" value="${p.id}" />
                                  <input type="number" name="quantity" value="1" min="1" max="${p.quantityAvailable}" class="form-control form-control-sm me-2" style="width:60px;">
                                  <button type="submit" class="btn btn-success btn-sm">Thêm vào giỏ</button>
                                </form>
                                <a href="${pageContext.request.contextPath}/user/detail/${p.id}" class="btn btn-outline-primary btn-sm ms-2">Chi tiết</a>
                              </div>
                            </div>
                          </div>
                        </div>
