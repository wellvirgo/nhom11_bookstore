...
<%@ page import="com.fasterxml.jackson.datatype.jsr310.ser.LocalDateTimeSerializer" %>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold">${orderStatistics.get("Processing")}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold">${orderStatistics.get("Shipped")}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold">${orderStatistics.get("Delivering")}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold">${orderStatistics.get("Delivered")}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold">${orderStatistics.get("Cancelled")}</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="orderTable" class="table table-hover align-middle datatable table-striped">
...
<%
    ...
    timeModule.addSerializer(LocalDateTime.class, new LocalDateTimeSerializer(DateTimeFormatter.ofPattern("yyyy/MM/dd")));
    mapper.registerModule(timeModule);
    mapper.disable(SerializationFeature.WRITE_DATE_KEYS_AS_TIMESTAMPS);
    String ordersJson = mapper.writeValueAsString(request.getAttribute("orders"));
%>
<script>
