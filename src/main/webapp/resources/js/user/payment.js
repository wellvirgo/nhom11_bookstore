...
document.addEventListener('DOMContentLoaded', function() {
    ...
    closeBtn.onclick = () => { modal.style.display = 'none'; clearSelection(); };
    modal.onclick = (e) => { if (e.target === modal) { modal.style.display = 'none'; clearSelection(); } };
...
document.getElementById('orderBtn').onclick = function(e) {
    ...
    const paymentMethod = document.querySelector('input[name="paymentMethod"]:checked').id; // Lấy id của radio được chọn
